...
$(function() {
        ...
        $.get("http://47.104.244.134:8080/goodstypelist.do", {
            ...
            for (var i = 0; i < data.length; i++) {
                var $li = $('<a href="list.html? token = token"><li class="list"></li></a>');
        ...
        $.get("http://47.104.244.134:8080/goodsbytid.do", {
            ...
            for (let i = 0; i < data.data.length; i++) {
                ...
                $(".J_goods_item cdb_item  a").eq(i).on("click", function() {
                    $(this).attr("href", 'http://localhost:8080/list.html?token=' + token + '&&id=' + data.data[i].id);
                })
                ...
                $(".cdb_bd a").on("click", function() {
                    $(this).attr("href", 'http://localhost:8080/list.html?token=' + token + '&&id=' + data.data[i].id);
                })
                $(".chaoshi_discount_listwrap a").on("click", function() {
                    $(this).attr("href", 'http://localhost:8080/list.html?token=' + token + '&&id=' + data.data[i].id);
                })

                $(".goods_pic").on("click", function() {
                    $(this).attr("href", 'http://localhost:8080/list.html?token=' + token + '&&id=' + data.data[i].id);
                })
                console.log($(".chaoshi_brand_row a"))
                $(".chaoshi_brand_item").on("click", function() {
                    $(this).attr("href", 'http://localhost:8080/list.html?token=' + token + '&&id=' + data.data[i].id);
                })
